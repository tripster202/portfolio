...
![alt text](<Course 1 Certificate - Foundations Data Everywhere.pdf>)
![alt text](<Course 2 Certificate - Ask Questions to Make Data-Driven Decisions>)
![alt text](<Course 3 Certificate - Prepare Data for Exploration>)
![alt text](<Course 4 Certificate - Process Data from Dirty to Clean>)
